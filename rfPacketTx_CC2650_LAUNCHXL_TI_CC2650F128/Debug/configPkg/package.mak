...
.dlls,em3 .dlls: rfPacketTx.pem3

-include package/cfg/rfPacketTx_pem3.mak
-include package/cfg/rfPacketTx_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/rfPacketTx_pem3.dep
endif
rfPacketTx.pem3: package/cfg/rfPacketTx_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
rfPacketTx.pem3 package/cfg/rfPacketTx_pem3.c: .libraries,em3
endif

package/cfg/rfPacketTx_pem3.c package/cfg/rfPacketTx_pem3.h package/cfg/rfPacketTx_pem3.xdl: override _PROG_NAME := rfPacketTx.xem3
package/cfg/rfPacketTx_pem3.c: package/cfg/rfPacketTx_pem3.cfg
package/cfg/rfPacketTx_pem3.xdc.inc: package/cfg/rfPacketTx_pem3.xdl
package/cfg/rfPacketTx_pem3.xdl package/cfg/rfPacketTx_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/rfPacketTx_pem3.cfg
	-$(RM) package/cfg/rfPacketTx_pem3.dep
	-$(RM) package/cfg/rfPacketTx_pem3.c
	-$(RM) package/cfg/rfPacketTx_pem3.xdc.inc

clean,em3::
	-$(RM) rfPacketTx.pem3
.executables,em3 .executables: rfPacketTx.xem3

rfPacketTx.xem3: |rfPacketTx.pem3

-include package/cfg/rfPacketTx.xem3.mak
rfPacketTx.xem3: package/cfg/rfPacketTx_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/rfPacketTx_pem3.oem3   package/cfg/rfPacketTx_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
rfPacketTx.xem3: export C_DIR=
rfPacketTx.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
rfPacketTx.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

rfPacketTx.test test,em3 test: rfPacketTx.xem3.test

rfPacketTx.xem3.test:: rfPacketTx.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 rfPacketTx.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.rfPacketTx.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,rfPacketTx.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
rfPacketTx_pem3.oem3,copy : package/cfg/rfPacketTx_pem3.oem3
rfPacketTx_pem3.sem3,copy : package/cfg/rfPacketTx_pem3.sem3
