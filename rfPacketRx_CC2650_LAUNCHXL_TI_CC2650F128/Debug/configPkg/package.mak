...
C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/ITarget.xs:
package.mak: C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/ITarget.xs
C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/C28_large.xs:
package.mak: C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/C28_large.xs
C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/C28_float.xs:
package.mak: C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/C28_float.xs
C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/package.xs:
package.mak: C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/package.xs
C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/arm/elf/IArm.xs:
package.mak: C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/arm/elf/IArm.xs
C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/arm/elf/package.xs:
package.mak: C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/arm/elf/package.xs
...
ti.targets.arm.elf.packageBase ?= C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/arm/elf/
...
.dlls,em3 .dlls: rfPacketRx.pem3

-include package/cfg/rfPacketRx_pem3.mak
-include package/cfg/rfPacketRx_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/rfPacketRx_pem3.dep
endif
rfPacketRx.pem3: package/cfg/rfPacketRx_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
rfPacketRx.pem3 package/cfg/rfPacketRx_pem3.c: .libraries,em3
endif

package/cfg/rfPacketRx_pem3.c package/cfg/rfPacketRx_pem3.h package/cfg/rfPacketRx_pem3.xdl: override _PROG_NAME := rfPacketRx.xem3
package/cfg/rfPacketRx_pem3.c: package/cfg/rfPacketRx_pem3.cfg
package/cfg/rfPacketRx_pem3.xdc.inc: package/cfg/rfPacketRx_pem3.xdl
package/cfg/rfPacketRx_pem3.xdl package/cfg/rfPacketRx_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/rfPacketRx_pem3.cfg
	-$(RM) package/cfg/rfPacketRx_pem3.dep
	-$(RM) package/cfg/rfPacketRx_pem3.c
	-$(RM) package/cfg/rfPacketRx_pem3.xdc.inc

clean,em3::
	-$(RM) rfPacketRx.pem3
.executables,em3 .executables: rfPacketRx.xem3

rfPacketRx.xem3: |rfPacketRx.pem3

-include package/cfg/rfPacketRx.xem3.mak
rfPacketRx.xem3: package/cfg/rfPacketRx_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/rfPacketRx_pem3.oem3   package/cfg/rfPacketRx_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
rfPacketRx.xem3: export C_DIR=
rfPacketRx.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
rfPacketRx.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

rfPacketRx.test test,em3 test: rfPacketRx.xem3.test

rfPacketRx.xem3.test:: rfPacketRx.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 rfPacketRx.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.rfPacketRx.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,rfPacketRx.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
rfPacketRx_pem3.oem3,copy : package/cfg/rfPacketRx_pem3.oem3
rfPacketRx_pem3.sem3,copy : package/cfg/rfPacketRx_pem3.sem3
